 ...
 */
public class MyPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         */
        void buildRenderers(MyPlayer player, RendererBuilderCallback callback);
    }
    ...
    public interface RendererBuilderCallback {
         ...
         *
         * @param trackNames The names of the available tracks, indexed by {@link MyPlayer} TYPE_*
         ...
         *     indexed by {@link MyPlayer} TYPE_* constants. May be null if there are no types with
         *     multiple tracks. An individual element may be null if it does not have multiple tracks.
         * @param renderers Renderers indexed by {@link MyPlayer} TYPE_* constants. An individual
    ...
    public MyPlayer(RendererBuilder rendererBuilder) {
    ...
    private class InternalRendererBuilderCallback implements RendererBuilderCallback {
        ...
        public void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources,
                                TrackRenderer[] renderers) {
            if (!canceled) {
                MyPlayer.this.onRenderers(trackNames, multiTrackSources, renderers);
            }
        }
        ...
        public void onRenderersError(Exception e) {
            if (!canceled) {
                MyPlayer.this.onRenderersError(e);
            }
        }
