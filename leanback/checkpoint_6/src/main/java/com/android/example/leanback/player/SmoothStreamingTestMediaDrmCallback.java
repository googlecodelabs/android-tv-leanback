...
/**
 * Demo {@link com.google.android.exoplayer.drm.StreamingDrmSessionManager} for smooth streaming test content.
 */
@TargetApi(18)
public class SmoothStreamingTestMediaDrmCallback implements MediaDrmCallback {
  ...
  public byte[] executeProvisionRequest(UUID uuid, ProvisionRequest request) throws IOException {
    ...
    return MyUtil.executePost(url, null, null);
  }
  ...
  public byte[] executeKeyRequest(UUID uuid, KeyRequest request) throws Exception {
    ...
    return MyUtil.executePost(url, request.getData(), KEY_REQUEST_PROPERTIES);
  }
