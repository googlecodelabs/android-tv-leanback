 ...
 */
public class EventLogger implements MyPlayer.Listener, MyPlayer.InfoListener,
    MyPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[MyPlayer.RENDERER_COUNT];
  }
